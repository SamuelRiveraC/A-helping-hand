                ...
                <div class="modal-body">
                    <form id='form1'>
                        ...
                        <div id="datosPer">
                            ...
                            <div class="form-group">
                                <label for="text" class="col-sm-4 control-label">Horario</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="horas_trab" id="horas_trab" type="text" placeholder="8:00 AM - 5:00 PM">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="text" class="col-sm-4 control-label">Indique si tiene niños en la institucion</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" id="GradoHijo" style="display:none">
                                <label for="text" class="col-sm-4 control-label">Indique grado cursante del hijo</label>
                                <div class="col-sm-10">
                        ...
                        <div id="formacionAca" style="display:none">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <label for="text" class="col-sm-12 control-label">Codigo area</label>
                                        <input type="number" class="form-control" name="Area_telf_casa" id="Area_telf_casa" placeholder="Codigo de area de casa">
                                    </div>
                                    
                                    <div class="col-6">
                                        <label for="text" class="col-sm-12 control-label">Numero</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <label for="text" class="col-sm-12 control-label">Codigo area</label>
                                        <input type="number" class="form-control" name="Area_telf_celular" id="Area_telf_celular" placeholder="Codigo de area celular">
                                    </div>
